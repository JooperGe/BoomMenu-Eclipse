...
public class CircleButton extends FrameLayout {
	...
	public CircleButton(Context context, AttributeSet attrs) {
		...
		// {
		if (false) {
			LayoutInflater.from(mContext).inflate(R.layout.circle_button, this,
					true);
		} else {
			LayoutInflater.from(mContext).inflate(
					R.layout.circle_button_below_lollipop, this, true);
		}
	...
	public void setOnCircleButtonClickListener(
			OnCircleButtonClickListener onCircleButtonClickListener, int index) {
	...
	public void setColor(int pressedColor, int normalColor) {
		Util.getInstance().setCircleButtonStateListDrawable(imageButton,
				radius, pressedColor, normalColor);
	}
