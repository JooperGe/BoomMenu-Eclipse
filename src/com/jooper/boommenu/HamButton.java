...
public class HamButton extends FrameLayout {
	...
	public HamButton(Context context, AttributeSet attrs) {
		...
		// {
		if (false) {
			LayoutInflater.from(mContext).inflate(R.layout.ham_button, this,
					true);
		} else {
			LayoutInflater.from(mContext).inflate(
					R.layout.ham_button_below_lollipop, this, true);
		}
	...
	public void setOnHamButtonClickListener(
			final OnHamButtonClickListener onHamButtonClickListener,
			final int index) {
	...
	public void setColor(int pressedColor, int normalColor) {
		Util.getInstance().setHamButtonStateListDrawable(frameLayout, width,
				height, pressedColor, normalColor);
	}
